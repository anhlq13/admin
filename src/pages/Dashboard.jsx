                    ...
                    <div className="col-xl-6 mb-4">
                        <div className="card card-header-actions h-100">
                            <div className="card-header">
                                Earnings Breakdown
                                <div className="dropdown no-caret">
                                    <button className="btn btn-transparent-dark btn-icon dropdown-toggle" id="areaChartDropdownExample" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i className="text-gray-500" data-feather="more-vertical" /></button>
                            ...
                            <div className="card-body">
                                <div className="chart-area"><canvas id="myAreaChart" width="100%" height={30} /></div>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-6 mb-4">
                        <div className="card card-header-actions h-100">
                            ...
                            <div className="card-body">
                                <div className="chart-bar"><canvas id="myBarChart" width="100%" height={30} /></div>
                            </div>
                        </div>
                    </div>
                </div>
